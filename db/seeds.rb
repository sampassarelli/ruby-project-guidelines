...
event5 = Event.create(event_name: "Bill Burr: LIVE", category: "Theater", city: "Minneapolis", zip: 60605)
event5 = Event.create(event_name: "Phantom of the Opera", category: "Theater", city: "Chicago", zip: 60605)
event5 = Event.create(event_name: "Chris Angel Live", category: "Theater", city: "Milwaukee", zip: 60605)
